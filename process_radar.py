...
fn_to_dstream_map = {'nsakazrge.20111112-20140207.nc': first_datastream, # 2011 - 2014
                     'nsakazrge.20140208-20191027.nc': second_datastream, # 2014 - 2019
                     'nsakazrge.20191028-20231231.nc': third_datastream} # 2019 - 2023

for save_filename, dstream in fn_to_dstream_map.items():
    print('\n', save_filename)
